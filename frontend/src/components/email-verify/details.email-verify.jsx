    ...
    return (
        <div className='mt-52 ml-5 mr-5 flex text-sm space-x-20'>
            ...
            <div>
                ...
                <p className='mt-2 cursor-pointer hover:text-red-500'>Design blog</p>
                <p className='mt-2 cursor-pointer hover:text-red-500'>Overtime podcast</p>
                <p className='mt-2 cursor-pointer hover:text-red-500'>Playoffs</p>
                <p className='mt-2 cursor-pointer hover:text-red-500'>Weekly Warm-Up</p>
                <p className='mt-2 cursor-pointer hover:text-red-500'>Refer a Friend</p>
