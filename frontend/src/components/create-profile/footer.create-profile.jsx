    ...
    const finish_onclick_handler = async () => {
        try {
            if (profile_details.profile_img) {
                ...
                await axios.post('http://localhost:5000/api/v1/account/create/api/v1/profile/get_s3_presigned_url', { username, name, type })
                    .then(async res => {
                        ...
                        await axios.put(res.data.body.s3_presigned_url, profile_details.profile_img)
                            .then(async () => {
                                await axios.put('http://localhost:5000/api/v1/account/create/api/v1/profile/edit_profile', {
